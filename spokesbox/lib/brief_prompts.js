...
PRIVACY RULE: If the reader discloses a sensitive personal topic (health, finances, medical issues, mental health, family stress, legal issues, relationship problems) AND includes a privacy signal (e.g. "don't mention," "private," "don't make assumptions," "keep it private," "don't reference directly"), you MUST NOT echo the specific private disclosure in the brief as a reader fact. Do NOT write sentences like "[topic] is a live stressor for them right now" or "they are dealing with [sensitive issue]." Instead, translate the sensitive context entirely into a tone or format rule, e.g.: "Keep tone calm, grounded, and practical. Do not reference personal stressors or make assumptions about the reader's circumstances."[PRIVACY_CONTEXT]

Output ONLY valid JSON: {"brief_text": "…", "edit_reason": "initial brief from onboarding"}`;
...
PRIVACY RULE: If the reader mentioned a sensitive personal topic (health, finances, medical, mental health, family stress, legal issues) alongside a privacy signal ("don't mention," "private," "don't make assumptions"), do NOT ask follow-up questions that probe or elaborate on those sensitive topics. Off-limits: "Tell me more about your health situation," "What financial stress are you dealing with?" Safe alternatives: ask about tone, length, topics they DO want covered, or preferred sources.[PRIVACY_CONTEXT]
